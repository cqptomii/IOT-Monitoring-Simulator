...
public:
    ...
    void add_scheduler_Arrow(const QPoint &end,const QString &s);
    void add_server_Arrow(const QPoint &end,const QString &s);
    void remove_server_arrow(const QString &s);
    void remove_scheduler_arrow(const QString &s);
